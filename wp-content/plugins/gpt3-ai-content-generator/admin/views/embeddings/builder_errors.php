...
<div class="tablenav top">
    <div class="alignleft actions bulkactions">
        <a href="<?php echo admin_url('admin.php?page=wpaicg_embeddings&action=builder&sub=error&sub_action=reindexall')?>" class="button button-primary"><?php echo esc_html__('Re-Index All','gpt3-ai-content-generator')?></a>
