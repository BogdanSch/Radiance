        ...
        <div>
          ...
          <p>The following table provides an overview of the parameters that are used by the chatbot.</p>
            <ol>
                ...
                <li><b>Temperature</b> - Controls the amount of randomness. Higher values will result in more random completions. Lower values will result in more predictable completions. The default value is 0.7. It can be set to a value between 0 and 1. <a href="https://aipower.org/gpt-3-temperature-settings/" target="_blank">Learn more</a>.</li>
                <li><b>Max Tokens</b> - The maximum number of tokens to generate. The default value is 1300. It can be set to a value between 1 and 1400. <a href="https://aipower.org/max-tokens/" target="_blank">Learn more</a>.</li>
                <li><b>Top P</b> - Controls the diversity of the generated text. Lower values will result in more predictable completions. Higher values will result in more random completions. The default value is 1.0. It can be set to a value between 0 and 1. <a href="https://aipower.org/top_p/" target="_blank">Learn more</a>.</li>
                <li><b>Best Of</b> - The number of different completions to return. The default value is 1. It can be set to a value between 1 and 20. <a href="https://aipower.org/best-of/" target="_blank">Learn more</a>.</li>
                <li><b>Frequency Penalty</b> - Controls the frequency of the generated text. Lower values will result in more frequent completions. Higher values will result in less frequent completions. The default value is 0.01. It can be set to a value between 0 and 2. <a href="https://aipower.org/frequency-penalty/" target="_blank">Learn more</a>.</li>
                <li><b>Presence Penalty</b> - Controls the frequency of the generated text. Lower values will result in more frequent completions. Higher values will result in less frequent completions. The default value is 0.01. It can be set to a value between 0 and 2. <a href="https://aipower.org/presence-penalty/" target="_blank">Learn more</a>.</li>
            </ol>
