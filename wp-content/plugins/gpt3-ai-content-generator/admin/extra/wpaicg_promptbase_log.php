...
$query = "SELECT * FROM ".$wpdb->prefix."wpaicg_promptbase_logs WHERE 1=1".$where;
...
<script>
    jQuery(document).ready(function ($){
        ...
        $('.wpaicg-view-log').click(function (){
            ...
            $('.wpaicg_modal_title').html('<?php echo esc_html__('View Promptbase Log','gpt3-ai-content-generator')?>');
